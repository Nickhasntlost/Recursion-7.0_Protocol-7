        ...
        >
          ...
          <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input className="w-full bg-surface-container-low border-none rounded-lg p-4 focus:ring-2 focus:ring-secondary-container focus:bg-surface-container-lowest transition-all outline-none" placeholder="Alex" type="text" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold ml-4">Last Name</label>
                <input className="w-full bg-surface-container-low border-none rounded-lg p-4 focus:ring-2 focus:ring-secondary-container focus:bg-surface-container-lowest transition-all outline-none" placeholder="Rivera" type="text" />
              </div>
              <div className="md:col-span-2 space-y-2">
                <label className="text-sm font-semibold ml-4">Email Address</label>
                <input className="w-full bg-surface-container-low border-none rounded-lg p-4 focus:ring-2 focus:ring-secondary-container focus:bg-surface-container-lowest transition-all outline-none" placeholder="alex@editorial.com" type="email" />
              </div>
            </div>
          </section>
          ...
          <section className="p-8 bg-surface-container-low rounded-xl flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="relative w-full md:w-72">
              <input className="w-full bg-surface-container-lowest border-none rounded-full py-3 pl-6 pr-24 focus:ring-2 focus:ring-secondary-container outline-none" placeholder="Code" type="text" />
              <button className="absolute right-1.5 top-1.5 bottom-1.5 px-6 bg-primary text-on-primary rounded-full text-xs font-bold uppercase tracking-widest hover:opacity-90 transition-opacity">Apply</button>
            </div>
          </section>
            ...
            <div className="bg-surface-container-lowest rounded-xl p-8 shadow-sm">
              <div className="flex gap-6 items-start pb-8 border-b border-surface-container-high">
                <div className="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0 bg-surface-container">
                  <img className="w-full h-full object-cover" alt="Event" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCbmeSi_Rc_g90_fkkiIKJiPDxtfR1Ib4f6DmOrzwWYsMqfl1_DjmuFiSvBSbD7owaUTa182DvwQy8VgXzX0VPFA_zfMOgyOPJOnm2hdarD2TUTTbrBcpk7boh9EBeTn0IXIFHbnhgaZ7bwnycknwbXhr8QRWIWUP_Tmnjhplx6VospGFDMOb-hFr-Bn3VoIQZM8DwlWBLwbY_L-ZMN8lIT57tE9eHkPtX-HSYhTSt_ODqBZN9vwv6l1JcJhAw-c1wYcDwgQP9AyWQ" />
                </div>
              ...
              <div className="py-8 space-y-6">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold">Premium Mezzanine</p>
              ...
              <Link to="/confirmation">
                <motion.button
                  className="w-full mt-10 bg-primary text-on-primary rounded-full py-5 flex items-center justify-center gap-3 group"
